...
public class adapter_rv_compradores extends RecyclerView.Adapter<adapter_rv_compradores.CompradoresviewHolder> implements View.OnClickListener, Filterable {
    ...
    public adapter_rv_compradores(ArrayList<Compradores> compradores_source, Context mContext, View view) {
    ...
    public CompradoresviewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.rv_compradores, viewGroup, false);
    ...
    public static class CompradoresviewHolder extends RecyclerView.ViewHolder{
        TextView txtNombre, txtNControl, txtFolio, txtImporte;
